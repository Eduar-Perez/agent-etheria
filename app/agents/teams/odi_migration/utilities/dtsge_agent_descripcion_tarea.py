...
def definir_promts_pasos_job(state: DescripcionState) -> DescripcionState:
    ...
    for archivo in archivos:
        ...
        for bloque in bloques:
            ...
            prompt_path = os.path.join('prompts', 'experto_dastage_extraccion.txt')
            ...
            prompt_path = os.path.join('prompts', 'experto_dastage_transformacion.txt')
            with open(prompt_path, 'r', encoding='utf-8') as f:
                prompt_template = f.read()
            ...
            # Leer el prompt desde el archivo de transformaciones
            prompt_path = os.path.join('prompts', 'experto_dastage_carge.txt')
            with open(prompt_path, 'r', encoding='utf-8') as f:
                prompt_template = f.read()
